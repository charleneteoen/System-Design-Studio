...
export default function Dashboard() {
  ...
  const [inputVariables, setInputVariables] = useState<InputVariable[]>([
    ...
    {
      id: "throwingTime",
      label: "Approx Throwing",
      sublabel: "Time For each Trip",
      value: "3 mins",
      icon: (
        <svg className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    {editingId === variable.id ? (
                      ...
                      <div className="flex items-center w-full">
                        ...
                        <div className="flex flex-col">
                          ...
                          <div className="text-2xl font-bold mt-1">{variable.value}</div>
                        </div>
                      </div>
                    )}
                  </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <Card className="bg-[#2d3e50] border-none text-white p-4">
              ...
              <p className="text-sm text-gray-300">
                Adding another bin in the central collection point can decrease the cost of clearing bins for this
                number of tenants
              </p>
            </Card>
          </div>
